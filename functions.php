...
function mytheme_scripts() {
	...
	wp_style_add_data( 'mytheme-style-bootstrap', 'rtl', 'replace' );
	
	
	
	wp_enqueue_style( 'mytheme-style-fa',get_template_directory_uri() . 'https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css' );
	wp_enqueue_style( 'mytheme-style-bootstrap',get_template_directory_uri() . '/bootstrap/css/bootstrap.min.css' );

	wp_enqueue_script( 'mytheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
	
	wp_enqueue_script( 'mytheme-js-jquery-js', get_template_directory_uri() . '/bootstrap/js/jquery.min.js', array(), _S_VERSION, true );
	
	wp_enqueue_script( 'mytheme-js-bootstrap-js', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', array(), _S_VERSION, true );
...
require get_template_directory() . '/inc/compp.php';
/**
